...
class Thrasher extends StatefulWidget {
  @override
  _ThrasherState createState() => _ThrasherState();
}
...
class _ThrasherState extends State<Thrasher> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        'https://firebasestorage.googleapis.com/v0/b/sneakerbot-8f31c.appspot.com/o/trasher%20wallpaper.jpg?alt=media&token=28c85fd7-b3c0-4604-82eb-78df6c8b6f67',
        fit: BoxFit.cover,
        loadingBuilder: (BuildContext context, Widget child,
          ...
          Padding(
            ...
            stream: db.collection('THRASHER').where("price", isLessThanOrEqualTo: precio).where("price", isGreaterThanOrEqualTo: preciomin)
            .where("size", isEqualTo: selectedUsState)
            .snapshots(),
