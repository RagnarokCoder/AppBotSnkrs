...
class Fendi extends StatefulWidget {
  Fendi( {Key key}) : super(key: key);

  @override
  _FendiState createState() => _FendiState();
}
...
class _FendiState extends State<Fendi> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        'https://firebasestorage.googleapis.com/v0/b/sneakerbot-8f31c.appspot.com/o/fendi%20wallpaper.jpg?alt=media&token=bf1ab537-dfca-4c46-8220-8833dc8e353e',
        fit: BoxFit.cover,
        loadingBuilder: (BuildContext context, Widget child,
          ...
          Padding(
                ...
                children: <Widget>[
                   ...
                   Container(
                    ...
                    child: ListView(
                     ...
                     _crearBotonRedondeado(Icons.person, 'Genero'),
                     SizedBox(width: 5,),
            ...
            stream: db.collection('FENDI').where("gender", isEqualTo: selectedUsState).where("price", isLessThanOrEqualTo: precio).where("price", isGreaterThanOrEqualTo: preciomin).snapshots(),
             ...
             if(!snapshot.hasData){
              ...
              return GridView.builder(
                ...
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                  ...
                  childAspectRatio: .6,// largo de la card.
                  crossAxisSpacing: 5
